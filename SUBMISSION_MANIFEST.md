...
| Main text | **3 997 words** (Introduction to Conclusion, headings included) |
...
| Word counts inside the journal's limits | `python _wordcount.py` | main **3 997**; Summary **299** |
...
Gates after Round-9: consistency **619/0**, word count **3 997 / 299** (headroom 3), docx
